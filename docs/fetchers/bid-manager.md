...
| `CUSTOM_DATES` in `dataRange` | requires building complex [`DataRange`](https://developers.google.com/bid-manager/reference/rest/v2/queries#DataRange) object | `dataRange IN (2025-01-01, 2025-12-31)` |
